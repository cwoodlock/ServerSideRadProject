...
public class OrderInfoService 
{
	...
	public OrderInfo save(OrderInfo orderInfo) {
		...
		//sets the new order to the current date
		setCurrentDate(orderInfo);																			
		
		ship = shipRepository.findOne(orderInfo.getShip().getSid());									
		shippingCompany = shippingCompanyRepository.findOne(orderInfo.getShippingCompany().getScid());
